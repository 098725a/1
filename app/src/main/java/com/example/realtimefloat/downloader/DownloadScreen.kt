...
@Composable
fun DownloadScreen(viewModel: ModelDownloadViewModel) {
    var url by remember { mutableStateOf("") }
    var modelName by remember { mutableStateOf("whisper-medium-quant") }
    val state by viewModel.progress.collectAsState(initial = DownloadState.Idle)
